...
func init() {
	...
	generateModuleCmd.Flags().BoolVar(&portableAPI, "portable-api", false, "use the portable dagger API (experimental): import dagger.io/dagger instead of vendoring core bindings")
}
